...
\begin{description}
  ...
  \item[Customer] Modela clientes finais com autenticação, dados de contato, endereço como JSON estruturado,
...
\begin{itemize}
  ...
  \item \texttt{OrderTypeEnum}: Modos de pedido (dine\_in, takeaway, delivery).
...
permitindo que Services específicos adicionem métodos customizados. Por exemplo, \texttt{CustomerService.create\_customer()}
...
\hspace{0.5cm} Todas as entidades implementam soft delete através do campo \texttt{deleted\_at}, exceto orders que são permantentemente armazenados para fins de auditoria e histórico.
