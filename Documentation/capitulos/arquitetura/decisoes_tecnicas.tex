...
\hspace{0.5cm} \textbf{Linguagem de programação: Python}
...
\textbf{Banco de dados: SQLite e ORM}
...
SQLModel unifica modelos SQLAlchemy com schemas Pydantic, eliminando duplicação entre camadas de dados e API.
